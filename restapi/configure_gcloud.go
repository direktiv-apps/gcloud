...
//go:generate swagger generate server --target ../../app --name Gcloud --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.GcloudAPI) {
...
func configureAPI(api *operations.GcloudAPI) http.Handler {
